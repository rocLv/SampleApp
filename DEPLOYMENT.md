...
sudo service unicorn_sample_app <start|stop|restart>
sudo service sidekiq_sample_app <start|stop>
```
...
```
/home/deployer/apps/sample_app/shared/.env.production
```
...
sudo service sidekiq_sample_app stop
sudo service sidekiq_sample_app start
```
